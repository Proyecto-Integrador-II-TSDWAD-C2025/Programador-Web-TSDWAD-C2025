...
export const routes: Routes = [
  ...
  { path: 'mi-rutina', loadComponent: () => import('./pages/mi-rutina/mi-rutina').then(m => m.MiRutina), canActivate: [authGuard] },
  { path: 'mi-plan-alimenticio', loadComponent: () => import('./pages/mi-plan-alimenticio/mi-plan-alimenticio').then(m => m.MiPlanAlimenticio), canActivate: [authGuard] },
  { path: 'planes', loadComponent: () => import('./pages/planes/planes').then(m => m.Planes), canActivate: [authGuard] },
  { path: 'planes/:id', loadComponent: () => import('./pages/plan-detalle/plan-detalle').then(m => m.PlanDetalle), canActivate: [authGuard] },
  ...
  { path: 'nutricionista/planes/:id/menu', loadComponent: () => import('./pages/nutricionista/planes/menu-plan-gestion').then(m => m.MenuPlanGestion), canActivate: [authGuard, staffRoleGuard] },
